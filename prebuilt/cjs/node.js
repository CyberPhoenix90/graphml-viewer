...
class Node {
    constructor(nodeXML) {
        ...
        if (data.length) {
            const shape = (_d = (_c = (_b = (_a = nodeXML.getElementsByTagName('y:ShapeNode')[0]) !== null && _a !== void 0 ? _a : nodeXML.getElementsByTagName('y:GenericNode')[0]) !== null && _b !== void 0 ? _b : nodeXML.getElementsByTagName('y:TableNode')[0]) !== null && _c !== void 0 ? _c : nodeXML.getElementsByTagName('y:ProxyAutoBoundsNode')[0]) !== null && _d !== void 0 ? _d : nodeXML.getElementsByTagName('y:SVGNode')[0];
            if (shape) {
                this.shape = shape;
    ...
    generateRegularPolygonVector(sides, rx, ry, offsetX, offsetY, startAngle) {
        ...
        const points = [];
        for (let i = 0; i < sides; i++) {
            points.push(new vector_js_1.Vector(offsetX + rx * Math.sin(startAngle), offsetY + ry * Math.cos(startAngle)));
            startAngle += step;
        }
        return points;
    }
