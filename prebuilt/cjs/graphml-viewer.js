...
const generic_node_js_1 = require("./generic_node.js");
const shape_node_js_1 = require("./shape_node.js");
const svg_node_js_1 = require("./svg_node.js");
    ...
    render(xmlDocument) {
        ...
        for (const node of nodeNodes) {
            ...
            if (node.getElementsByTagName('y:ShapeNode')[0]) {
                ...
                nodeWrapper = new generic_node_js_1.GenericNode(node);
            }
